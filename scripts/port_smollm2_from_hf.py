...
from smollm2_full_sft import SmolLM2, ModelConfig
...
if __name__ == '__main__':
    ...
    ap.add_argument("--model-name", "-m", type=str, required=True, choices=list(MODEL_NAME_TO_HF_CHECKPOINT.keys()))
